...
#ifndef GOLD_STOLEN_DIALOG_H
#define GOLD_STOLEN_DIALOG_H
class GoldStolenDialog: public LwDialogBase
{
public:
    static std::string get_resource_name ()
      {
        return "gold-stolen.ui";
      }

    GoldStolenDialog (BaseObjectType* o,
