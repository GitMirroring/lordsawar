...
#ifndef CITY_PERSUADED_DIALOG_H
#define CITY_PERSUADED_DIALOG_H
class CityPersuadedDialog: public LwDialogBase
{
public:
    static std::string get_resource_name ()
      {
        return "city-persuaded.ui";
      }

    CityPersuadedDialog (BaseObjectType* o,
    ...
    void setup (Glib::ustring city_name, guint32 num_armies)
      {
        Glib::ustring s =
          String::ucompose
