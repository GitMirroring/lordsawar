...
Gtk::HeaderBar * GameWindow::create_header_bar (TurnIndicator *turn_indicator, Gtk::MenuButton *menu_button)
{
...
void GameWindow::new_network_game (GameScenario *game_scenario, NextTurnNetworked *next_turn)
{
  setup_game_object (game_scenario, next_turn);
  setup_signals ();
...
bool GameWindow::on_close_request ()
{
  if (confirm_dialog)
    {
...
sigc::signal<void ()> GameWindow::signal_game_ended ()
{
  return m_game_ended;
}

sigc::signal<void ()> GameWindow::signal_game_ended_start_new ()
{
  return m_game_ended_start_new;
}

sigc::signal<void ()> GameWindow::signal_show_lobby ()
{
  return m_show_lobby;
}

void GameWindow::on_show_keyboard_shortcuts ()
{
...
void GameWindow::on_game_action_added (Glib::RefPtr<Gio::SimpleAction> action)
{
  m_simple_actions[action->get_name ()] = action;
}

void GameWindow::setup_accels ()
{
...
void GameWindow::handle_confirmation_result (bool should_quit)
{
  if (!should_quit)
    return;
...
void GameWindow::application_quit ()
{
...
void GameWindow::action_connect (Glib::ustring name, sigc::slot<void()> slot)
{
  auto simple =
...
void GameWindow::setup_header_bar ()
{
...
void GameWindow::setup_smallmap ()
{
...
void GameWindow::add_connection (sigc::connection c)
{
  m_connections.push_back (c);
}

void GameWindow::setup_game_object (GameScenario *game_scenario, NextTurn *nextTurn)
{
...
void GameWindow::setup_network_play_signals ()
{
...
void GameWindow::setup_game_signals ()
{
  add_connection
...
void GameWindow::setup_action_signals ()
{
...
void GameWindow::give_some_cheese ()
{
