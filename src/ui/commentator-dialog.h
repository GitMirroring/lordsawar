...
#ifndef COMMENTATOR_DIALOG_H
#define COMMENTATOR_DIALOG_H
class CommentatorDialog: public LwDialogBase
{
public:
    static std::string get_resource_name ()
      {
        return "commentator.ui";
      }

    CommentatorDialog (BaseObjectType* o,
