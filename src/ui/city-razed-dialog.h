...
#ifndef CITY_RAZED_DIALOG_H
#define CITY_RAZED_DIALOG_H
class CityRazedDialog: public LwDialogBase
{
public:
    static std::string get_resource_name ()
      {
        return "city-razed.ui";
      }

    CityRazedDialog (BaseObjectType* o,
    ...
    void setup (City *city)
      {
        ...
        set_title (String::ucompose (_("Razed %1"), city->getName ()));
