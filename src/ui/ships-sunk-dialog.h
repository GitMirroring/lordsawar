...
#ifndef SHIPS_SUNK_DIALOG_H
#define SHIPS_SUNK_DIALOG_H
class ShipsSunkDialog: public LwDialogBase
{
public:
    static std::string get_resource_name ()
      {
        return "ships-sunk.ui";
      }

    ShipsSunkDialog (BaseObjectType* o,
    ...
    void setup (Player *p, int num_armies)
      {
        (void) p;
        Glib::ustring s =
          String::ucompose
          (ngettext ("%1 army unit was sunk to the watery depths!",
