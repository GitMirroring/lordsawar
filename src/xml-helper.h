...
//  Copyright (C) 2011, 2012, 2014, 2021, 2026 Ben Asselstine
//
...
/** This class is intended to make xml handling easier. It offers
  ...
  * Open a new tag with open_tag (), save your data with save () and close the
  * tag with close_tag (). The output will look like:
  *
  * <map>
  *     <maptile>
  *         <d_x> 50 </d_x>
  ...
  * 
  * Loading:
  * First, you supply xml_helper with callback functions via register_tag.
  *
...
class XML_Helper: public xmlpp::SaxParser
{
    public:
        ...
        /** Opens a new subtag
          ...
          */
        bool open_tag (Glib::ustring name);
        ...
        /** Save data
          ...
          * @return true on success, false otherwise
          */
        bool save (Glib::ustring identifier, const Glib::ustring value);
        bool save (Glib::ustring identifier, const int value);
        bool save (Glib::ustring identifier, const guint32 value);
        bool save (Glib::ustring identifier, const bool value);
        bool save (Glib::ustring identifier, const double value);
        bool save (Glib::ustring identifier, unsigned long int value);
	bool save (Glib::ustring identifier, const std::vector<Gdk::RGBA> value);
	bool save (Glib::ustring identifier, const Gdk::RGBA value);
        ...
        /** Registers a new tag handler
          ...
          * @return true on success, false otherwise
          */
        bool register_tag (Glib::ustring tag, XML_Slot callback);
        ...
        /** Provides cached data
          ...
          * translated ro not.
          */
        bool get (Glib::ustring& data, Glib::ustring name);
        bool get (bool& data, Glib::ustring name);
        bool get (int& data, Glib::ustring name);
        bool get (guint32& data, Glib::ustring name);
        bool get (double& data, Glib::ustring name);
	bool get (std::vector<Gdk::RGBA> & data, Glib::ustring name);
	bool get (Gdk::RGBA & data, Glib::ustring name);

        //! Returns the version number of the save file
        Glib::ustring get_version () const {return m_version;}
        ...
        static guint32 flags_from_string (Glib::ustring flags, guint32 (*flagStrToNum)(Glib::ustring));
        

    protected:
        void on_start_element (const xmlpp::ustring& name,const xmlpp::SaxParser::AttributeList& properties) override;
	...
	bool lang_check (Glib::ustring lang);
        ...
        //streams, m_fout and m_fin are used when it comes to file
        //handling, m_in and m_out are used when actually reading or
        //writing data (either point to m_fout or m_fin or have a
        //separate stream)
        std::istringstream* m_inbuf;
        ...
        std::map<Glib::ustring, XML_Slot> m_callbacks;
        std::map<Glib::ustring, Glib::ustring> m_data;
        std::map<Glib::ustring, Glib::ustring> m_lang;
        
        Glib::ustring m_last_opened;
...
{
public:
    VersionLoader (Glib::ustring filename, Glib::ustring tag,
                   Glib::ustring &version, bool &broken)
      {
        ...
        if (in)
          {
            ...
            helper.register_tag (tag,
                                 sigc::mem_fun (*this, &VersionLoader::load));
