...
void ShieldSetWindow::setup (Shieldset *shieldset)
{
  m_shieldset = NULL;
  if (shieldset)
    {
...
void ShieldSetWindow::setup_header_bar (Gtk::MenuButton *menu_button)
{
...
void ShieldSetWindow::setup_treeview ()
{
...
void ShieldSetWindow::fill_treeview ()
{
  m_store->remove_all ();
  if (m_shieldset)
    {
...
Gtk::Box *ShieldSetWindow::create_attribute_row (Glib::ustring title, Glib::ustring desc,
                                                 Glib::ustring css)
{
...
void ShieldSetWindow::add_connection (sigc::connection c)
{
  m_connections.push_back (c);
}

void ShieldSetWindow::add_action_connection (sigc::connection c)
{
  m_action_connections.push_back (c);
}

void ShieldSetWindow::action_connect (Glib::ustring name, sigc::slot<void()> slot)
{
  auto simple =
...
void ShieldSetWindow::connect_action_signals ()
{
  action_connect
    ("shieldset.file.new",
     [this] ()
...
void ShieldSetWindow::disconnect_action_signals ()
{
...
void ShieldSetWindow::load_shieldset (Glib::ustring filename, sigc::slot<void(bool)> after)
{
...
void ShieldSetWindow::change_pic (Shield::Color color, TarFileMaskedImage *mim,
                                  Glib::ustring msg,
...
void ShieldSetWindow::update_actions ()
{
...
Shield * ShieldSetWindow::get_current_shield ()
{
...
void ShieldSetWindow::update_shieldset_panel ()
{
  bool sensitive;
...
Shield* ShieldSetWindow::get_shield_by_index (ShieldSetUndoAction_ShieldIndex *a)
{
  auto row = m_store->get_item(a->get_index ());
  return row->m_shield;
}

UndoAction* ShieldSetWindow::execute_action (UndoAction *a2)
{
...
void ShieldSetWindow::reload_shieldset (ShieldSetUndoAction_Save *action)
{
...
bool ShieldSetWindow::doReloadShieldset (ShieldSetUndoAction_Save *action)
{
  Glib::ustring olddir = m_shieldset->getDirectory ();
  Glib::ustring oldname =
    File::get_basename (m_shieldset->getConfigurationFile (true));
...
void ShieldSetWindow::check_discard (Glib::ustring msg, sigc::slot<void(bool)> after)
{
  if (m_shieldset_modified || m_new_shieldset_needs_saving)
    {
...
void ShieldSetWindow::check_name_valid (bool existing, sigc::slot<void(bool)> after)
{
...
void ShieldSetWindow::check_name_valid2 (bool existing, Glib::ustring newname,
...
void ShieldSetWindow::check_save_valid (bool existing, sigc::slot<void(bool)> after)
{
  check_name_valid
    (existing,
...
void ShieldSetWindow::setup_accels ()
{
...
void ShieldSetWindow::copy_white_down ()
{
  Glib::ustring err = "";
...
void ShieldSetWindow::save_current_shieldset_file_as (sigc::slot<void(bool)> after)
{
  LwDialog::save
...
void ShieldSetWindow::save_current_shieldset_file (Glib::ustring filename, sigc::slot<void(bool)> after)
{
  m_current_save_filename = filename;
...
void ShieldSetWindow::check_quit (sigc::slot<void(bool)> after)
{
  if (m_shieldset_modified || m_new_shieldset_needs_saving)
    {
      auto d = Gtk::AlertDialog::create (_("Save changes?"));
...
void ShieldSetWindow::setup_quit ()
{
