...
void ArmySetWindow::setup (Shieldset *shieldset, Armyset *armyset)
{
...
void ArmySetWindow::setup_header_bar (Gtk::MenuButton *menu_button)
{
...
Gtk::Box *ArmySetWindow::create_attribute_row (Glib::ustring title, Glib::ustring desc,
                                               Glib::ustring css)
{
...
void ArmySetWindow::add_connection (sigc::connection c)
{
  m_connections.push_back (c);
}

void ArmySetWindow::add_action_connection (sigc::connection c)
{
  m_action_connections.push_back (c);
}

void ArmySetWindow::action_connect (Glib::ustring name, sigc::slot<void()> slot)
{
  auto simple =
...
void ArmySetWindow::connect_action_signals ()
{
  action_connect
    ("armyset.file.new",
     [this] ()
...
void ArmySetWindow::block_signals ()
{
  for (auto c : m_connections)
    c.block ();
}

void ArmySetWindow::unblock_signals ()
{
  for (auto c : m_connections)
    c.unblock ();
}
...
void ArmySetWindow::disconnect_action_signals ()
{
...
void ArmySetWindow::load_armyset (Glib::ustring filename, sigc::slot<void(bool)> after)
{
...
ArmyProto *ArmySetWindow::get_selected_army ()
{
...
guint32 ArmySetWindow::get_selected_index ()
{
  return m_selection_model->get_selected ();
}

void ArmySetWindow::set_move_bonus (Gtk::Switch *sw, ArmyProto *a, guint32 val)
{
...
void ArmySetWindow::set_army_bonus (Gtk::Switch *sw, ArmyProto *a, guint32 val)
{
...
bool ArmySetWindow::is_bottom_row_selected ()
{
...
bool ArmySetWindow::is_top_row_selected ()
{
  const guint n_items = m_store->get_n_items ();
  if (n_items == 0)
    return false;
...
void ArmySetWindow::update_actions ()
{
...
void ArmySetWindow::update_armyset_panel ()
{
  bool sensitive;
  disconnect_signals ();
  if (m_armyset)
...
Gtk::ScrolledWindow* ArmySetWindow::populate_misc_images ()
{
...
Gtk::ScrolledWindow* ArmySetWindow::populate_selector_images ()
{
  auto scrolled_window = Gtk::make_managed<Gtk::ScrolledWindow> ();
  scrolled_window->set_policy
    (Gtk::PolicyType::NEVER, Gtk::PolicyType::AUTOMATIC);
...
Gtk::ScrolledWindow* ArmySetWindow::populate_army_panel ()
{
...
void ArmySetWindow::reselection (const Glib::RefPtr<ArmyProtoRow>& target)
{
...
Gtk::Box* ArmySetWindow::populate_side_pane ()
{
...
Gtk::Box* ArmySetWindow::populate_armies ()
{
...
UndoAction* ArmySetWindow::execute_action (UndoAction *a2)
{
...
void ArmySetWindow::reload_armyset (ArmySetUndoAction_Save *action)
{
...
void ArmySetWindow::check_discard (Glib::ustring msg, sigc::slot<void(bool)> after)
{
  if (m_armyset_modified || m_new_armyset_needs_saving)
    {
...
void ArmySetWindow::check_name_valid (bool existing, sigc::slot<void(bool)> after)
{
...
void ArmySetWindow::check_name_valid2 (bool existing, Glib::ustring newname,
...
bool ArmySetWindow::is_valid_name ()
{
  Glib::ustring file =
    Armysetlist::instance ()->lookupConfigurationFileByName (m_armyset);
  if (file == "")
...
void ArmySetWindow::check_save_valid (bool existing, sigc::slot<void(bool)> after)
{
  check_name_valid
    (existing,
...
void ArmySetWindow::setup_accels ()
{
...
void ArmySetWindow::save_current_armyset_file_as (sigc::slot<void(bool)> after)
{
  LwDialog::save
...
void ArmySetWindow::save_current_armyset_file (Glib::ustring filename, sigc::slot<void(bool)> after)
{
  m_current_save_filename = filename;
...
void ArmySetWindow::check_quit (sigc::slot<void(bool)> after)
{
  if (m_armyset_modified || m_new_armyset_needs_saving)
    {
      auto d = Gtk::AlertDialog::create (_("Save changes?"));
...
void ArmySetWindow::change_image (Glib::ustring msg, TarFileImage *im,
...
void ArmySetWindow::on_change_clicked (Glib::ustring msg, TarFileImage *im)
{
  change_image
    (msg, im,
...
void ArmySetWindow::change_image (Glib::ustring msg, TarFileMaskedImage *im, int lone,
                                  sigc::slot<void(bool, bool, Glib::ustring)> after)
{
  Glib::ustring imgname = im->getName ();
...
void ArmySetWindow::on_change_clicked (Glib::ustring msg, TarFileMaskedImage *im, int lone)
{
  change_image
    (msg, im, lone,
     [this, im](bool err, bool cleared, Glib::ustring f)
...
void ArmySetWindow::on_army_change_clicked (Glib::ustring msg, TarFileMaskedImage *im, int lone)
{
...
void ArmySetWindow::setup_treeview ()
{
...
void ArmySetWindow::fill_treeview ()
{
  m_store->remove_all ();
  if (m_armyset)
    {
...
ArmyProto* ArmySetWindow::get_army_by_index (ArmySetUndoAction_ArmyIndex *i)
{
...
void ArmySetWindow::scroll_army_to_top ()
{
  m_scrolled_window->get_vadjustment ()->set_value (0.0);
}

void ArmySetWindow::scroll_treeview_to_bottom ()
{
  guint n = m_store->get_n_items ();
...
void ArmySetWindow::clear_army_panel ()
{
...
bool ArmySetWindow::calculate_make_same ()
{
  auto a = get_selected_army ();
  if (a)
    {
...
void ArmySetWindow::sync_make_same ()
{
