...
void TileSetWindow::setup (Shieldset *shieldset, Tileset *tileset)
{
...
void TileSetWindow::setup_header_bar (Gtk::MenuButton *menu_button)
{
...
Gtk::Box *TileSetWindow::create_attribute_row (Glib::ustring title, Glib::ustring desc,
                                               Glib::ustring css)
{
...
void TileSetWindow::add_connection (sigc::connection c)
{
  m_connections.push_back (c);
}

void TileSetWindow::add_action_connection (sigc::connection c)
{
  m_action_connections.push_back (c);
}

void TileSetWindow::action_connect (Glib::ustring name, sigc::slot<void()> slot)
{
  auto simple =
...
void TileSetWindow::connect_action_signals ()
{
  action_connect
    ("tileset.file.new",
     [this] ()
...
void TileSetWindow::block_signals ()
{
  for (auto c : m_connections)
    c.block ();
}

void TileSetWindow::unblock_signals ()
{
  for (auto c : m_connections)
    c.unblock ();
}
...
void TileSetWindow::disconnect_action_signals ()
{
...
void TileSetWindow::load_tileset (Glib::ustring filename, sigc::slot<void(bool)> after)
{
...
guint32 TileSetWindow::get_selected_index ()
{
  return m_selection_model->get_selected ();
}

void TileSetWindow::connect_signals ()
{
  add_connection
...
void TileSetWindow::update_actions ()
{
...
void TileSetWindow::update_tileset_panel ()
{
  bool sensitive;
  disconnect_signals ();
  if (m_tileset)
...
Gtk::ScrolledWindow* TileSetWindow::populate_misc_images ()
{
...
Gtk::Box * TileSetWindow::populate_mini_map_colors ()
{
  auto box = Gtk::make_managed<Gtk::Box> (Gtk::Orientation::VERTICAL);
  box->set_margin (6);
...
Gtk::ScrolledWindow* TileSetWindow::populate_tile_panel ()
{
...
Gtk::Box* TileSetWindow::populate_side_pane ()
{
...
Gtk::Box* TileSetWindow::populate_tiles ()
{
...
UndoAction* TileSetWindow::execute_action (UndoAction *a2)
{
...
void TileSetWindow::reload_tileset (TileSetUndoAction_Save *action)
{
...
void TileSetWindow::check_discard (Glib::ustring msg, sigc::slot<void(bool)> after)
{
  if (m_tileset_modified || m_new_tileset_needs_saving)
    {
...
void TileSetWindow::check_name_valid (bool existing, sigc::slot<void(bool)> after)
{
...
void TileSetWindow::check_name_valid2 (bool existing, Glib::ustring newname,
...
bool TileSetWindow::is_valid_name ()
{
  Glib::ustring file =
    Tilesetlist::instance ()->lookupConfigurationFileByName (m_tileset);
  if (file == "")
...
void TileSetWindow::check_save_valid (bool existing, sigc::slot<void(bool)> after)
{
  check_name_valid
    (existing,
...
void TileSetWindow::setup_accels ()
{
...
void TileSetWindow::save_current_tileset_file_as (sigc::slot<void(bool)> after)
{
  LwDialog::save
...
void TileSetWindow::save_current_tileset_file (Glib::ustring filename, sigc::slot<void(bool)> after)
{
  m_current_save_filename = filename;
...
void TileSetWindow::check_quit (sigc::slot<void(bool)> after)
{
  if (m_tileset_modified || m_new_tileset_needs_saving)
    {
      auto d = Gtk::AlertDialog::create (_("Save changes?"));
...
void TileSetWindow::setup_treeview ()
{
...
void TileSetWindow::fill_treeview ()
{
  m_store->remove_all ();
  if (m_tileset)
    {
...
Tile* TileSetWindow::get_tile_by_index (TileSetUndoAction_TileIndex *i)
{
...
void TileSetWindow::scroll_tile_to_top ()
{
  m_scrolled_window->get_vadjustment ()->set_value (0.0);
}

void TileSetWindow::scroll_treeview_to_bottom ()
{
...
void TileSetWindow::clear_tile_panel ()
{
...
void TileSetWindow::change_image (Glib::ustring msg, TarFileImage *im,
...
void TileSetWindow::on_change_clicked (Glib::ustring msg, TarFileImage *im)
{
  change_image
    (msg, im,
...
void TileSetWindow::change_image (Glib::ustring msg, TarFileMaskedImage *im, int lone,
                                  sigc::slot<void(bool, bool, Glib::ustring)> after)
{
  Glib::ustring imgname = im->getName ();
...
void TileSetWindow::on_change_clicked (Glib::ustring msg, TarFileMaskedImage *im, int lone)
{
  change_image
    (msg, im, lone,
     [this, im ](bool err, bool cleared, Glib::ustring f)
...
void TileSetWindow::on_flag_change_clicked (Glib::ustring msg, TarFileMaskedImage *im, int lone)
{
...
bool TileSetWindow::is_second_color_sensitive ()
{
  auto tile = get_selected_tile ();
  if (!tile)
    return false;
...
bool TileSetWindow::is_third_color_sensitive ()
{
  auto tile = get_selected_tile ();
  if (!tile)
    return false;
...
void TileSetWindow::update_colorbuttons ()
{
...
void TileSetWindow::set_default_values_by_type ()
{
  disconnect_signals ();
  auto t = get_selected_tile ();
  switch (t->getType ())
